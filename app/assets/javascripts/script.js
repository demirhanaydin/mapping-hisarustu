...
$(document).ready(function(){
  var map = L.map('map').setView([41.08522, 29.04672], 15);
      L.tileLayer('http://{s}.tile.cloudmade.com/'+window.cloudmade_api_key+'/997/256/{z}/{x}/{y}.png', {
          attribution: 'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="http://cloudmade.com">CloudMade</a>',
          maxZoom: 18
      }).addTo(map);

  // var marker = L.marker([41.08522, 29.04672]).addTo(map);
  // var marker = L.marker([41.08522, 29.04472]).addTo(map);
  // var marker = L.marker([41.08622, 29.04472]).addTo(map);
  // var marker = L.marker([41.08522, 29.04072]).addTo(map);
